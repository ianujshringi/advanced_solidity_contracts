...
contract CSAMM {
        ...
        returns (uint256 shares)
    {
        ...
        /*  let
            ...
            s = (a*t)/l
        */
        if (totalSupply == 0) shares = d0 + d1;
        else shares = ((d0 + d1) * totalSupply) / (reserve0 + reserve1);
